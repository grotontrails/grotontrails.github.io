...
leftInset+=paddingLeft;var marginLeft=-1*leftInset;$(imgDiv).setStyle({marginLeft:px(marginLeft),marginRight:0,paddingBottom:0,paddingLeft:0,paddingRight:0});if(this.debugBorders)imgDiv.style.border="1px solid blue";if(windowsInternetExplorer&&browserVersion<7)
...
{fixAllIEPNGs(transparentGifURL());setTimeout(fixupIEPNGBGsInTree.bind(null,contentDiv,true),1);if(browserVersion>=8)
{joltLater(this.div());}}
