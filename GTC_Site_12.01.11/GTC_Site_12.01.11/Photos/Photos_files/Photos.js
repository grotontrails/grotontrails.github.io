...
{return IWCreateMediaCollection("http://www.grotontrails.org/GTC_Site_12.01.11/Photos/Photos_files/rss.xml",true,6,["No photos yet","%d photo","%d photos"],["","%d clip","%d clips"]);}
function initializeMediaStream_id2()
{createMediaStream_id2().load('http://www.grotontrails.org/GTC_Site_12.01.11/Photos',function(imageStream)
...
adjustLineHeightIfTooBig('id3');adjustFontSizeIfTooBig('id3');Widget.onload();fixAllIEPNGs('../Media/transparent.gif');fixupAllIEPNGBGs();applyEffects()
