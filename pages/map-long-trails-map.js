...
function main() {
	...
	loadJSON('/geo/walkingroute-southgrotontour.geojson',function(response) { overlaysJSON[0] = JSON.parse(response); complete() })
	loadJSON('/geo/walkingroute-eastgrotontour.geojson', function(response) { overlaysJSON[1] = JSON.parse(response); complete() })		
	loadJSON('/geo/walkingroute-westgrotontour.geojson', function(response) { overlaysJSON[2] = JSON.parse(response); complete() })
}
